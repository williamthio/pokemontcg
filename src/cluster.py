...
def main():
    if len(sys.argv) < 3:
        print("Usage: python cluster.py <start_clusters> <end_clusters>")
        sys.exit(1)
    ...
    start_clusters = int(sys.argv[1])
    end_clusters = int(sys.argv[2])
    silhouette_scores = []
    wcss = []
    ...
    output_file_path = "src/data/clustered_tournament_decks.csv"
